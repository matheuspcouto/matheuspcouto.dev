...
describe('CertificationsComponent', () => {
  ...
  it('should initialize with certifications list using signal', () => {
    expect(component['certifications']).toBeDefined();
    expect(component['certifications']().length).toBeGreaterThan(0);
  });

  it('should initialize with certificate index equal to 3 using signal', () => {
  ...
  it('should increase certificate index by 3 using signal update', () => {
